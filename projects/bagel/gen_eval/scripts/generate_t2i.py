...
sys.path.insert(0, "/root/data/projects/bagel/Bagel")
...
parser.add_argument("--model_path", type=str, default="/root/data/projects/bagel/models/BAGEL-7B-MoT")
...
if args.benchmark == "dpg":
    prompt_dir = "/root/data/projects/bagel/gen_eval/ELLA/dpg_bench/prompts"
    ...
    qib_prompts = "/root/data/projects/bagel/gen_eval/prompts/qib_prompts.jsonl"
    prompts = []
