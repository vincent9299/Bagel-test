...
Usage:
    ...
    # with LoRA
    CUDA_VISIBLE_DEVICES=1 LORA_PATH=/root/data/projects/bagel/results/lora_overfit/checkpoints/final/lora.safetensors \
...
VLMKIT = "/root/data/projects/bagel/VLMEvalKit"
