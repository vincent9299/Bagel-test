...
export LMUData=/root/data/projects/bagel/LMUData
export HF_HOME=/root/data/projects/bagel/hf_home
WORK_DIR=${WORK_DIR:-/root/data/projects/bagel/eval_outputs/base}
...
for ds in "${DATASETS[@]}"; do
  ...
  python /root/data/projects/bagel/Bagel/scripts/run_bagel_eval.py \
